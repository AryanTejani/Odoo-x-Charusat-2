      ...
      <div className="max-w-7xl mx-auto flex justify-between items-center py-3 px-4">
        ...
        <nav className="hidden md:flex space-x-6">
          {isAuthenticated ? (
            ...
            <>
              <Link to="/workouts" className="text-gray-800 font-medium hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition-all duration-200 py-1">
                Workouts
              </Link>
              <Link to="/recipe" className="text-gray-800 font-medium hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition-all duration-200 py-1">
                Recipe
              </Link>
              <Link to="/detect" className="text-gray-800 font-medium hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition-all duration-200 py-1">
                Chakra Tracker
              </Link>
              <Link to="/ai" className="text-gray-800 font-medium hover:text-blue-600 border-b-2 border-transparent hover:border-blue-600 transition-all duration-200 py-1">
                Personalize Ai
              </Link>
            </>
          ) : (
            ...
            <>
              <span onClick={handleUnauthorizedClick} className="text-gray-400 cursor-not-allowed font-medium py-1">
                Workouts
              </span>
              <span onClick={handleUnauthorizedClick} className="text-gray-400 cursor-not-allowed font-medium py-1">
                Recipe
